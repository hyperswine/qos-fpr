...
/* a windowing host (GLFW under FPR_DESKTOP_GL) feeds key
 * events translated to EVDEV CODES through here; they pass the same
 * modifier machine as device records.  Returns 0 (and drops the
