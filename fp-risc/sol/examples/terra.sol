...
addLog : unsafe a235 -> _ -> _ .
addLog s g = {g | log = takeN 5 (s :: g.log)}.

takeN : unsafe Int -> List g234 -> List g234 .
takeN n xs | n == 0 = [].
takeN n xs | xs == [] = [].
...
commitPlace : unsafe Int -> _ -> Int -> _ -> _ .
commitPlace i c k g =
  p = me g;
...
resolveDamage : unsafe Int -> Int -> _ -> _ .
...
handRow : unsafe Int -> List _ -> List ui.Html .
handRow i cs | cs == [] = [].
handRow i cs = case cs of c :: r -> handCard i c :: handRow (i + 1) r.

playerPanel : unsafe y239 -> _ -> Bool -> ui.Html .
